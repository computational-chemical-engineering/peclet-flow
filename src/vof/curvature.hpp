/// @file
/// @brief flow — thin shim: the container-free VoF height-function / paraboloid curvature kernels
/// (rung V3) now live in `core`.
///
...
/// `core/include/peclet/core/vof/curvature.hpp` under `peclet::core::vof`; this header is the
