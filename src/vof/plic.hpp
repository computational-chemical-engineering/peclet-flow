/// @file
/// @brief flow — thin shim: the container-free VoF PLIC geometric toolbox (rung V0) now live in
/// `core`.
///
...
/// `core/include/peclet/core/vof/plic.hpp` under `peclet::core::vof`; this header is the
