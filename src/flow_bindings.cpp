...
static void bind_solver(nb::module_& m, const char* name) {
  ...
  nb::class_<S>(m, name)
      ...
      .def(
          ...
          "What still REFUSES one, with a message naming the three spacings and what lifts it: "
          "enable_vof (Phase 3), and hydro_force_torque_reaction only when the scene MOVES under "
          "cut-cell pressure (its v3 transposed-stress wall torque, doc/units_escalation.md E3). "
