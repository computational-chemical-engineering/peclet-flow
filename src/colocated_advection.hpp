...
///
/// NOTE: in phase 2 (no pressure) the advecting velocity is the plain cell->face average of the
/// stored cell velocities. Once the approximate projection lands (phase 3), the natural advecting
/// field is the projected, divergence-free face velocity — this header's adv_vel is where that swap
/// happens.
...
// fd-component. Independent of the advected component `comp` (all components are co-located at the
// center).
template <class A>
