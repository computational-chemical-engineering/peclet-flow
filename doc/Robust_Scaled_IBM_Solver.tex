...
\begin{align}
    a'_c &= \mathcal{D}_\mathrm{rescale} \, a_c + \sum_d \mathcal{N}_{c,d} \, \mathcal{R}_d \, a_{ghost,d}\\
    a'_{nb,d} &= \mathcal{D}_\mathrm{rescale} \, a_{nb,d} + \sum_d \mathcal{N}_{nb,d}  \, \mathcal{R}_d \, a_{ghost,d} \\
    a'_{nb,\mathrm{other}} &= \mathcal{D}_\mathrm{rescale} \, a_{nb,\mathrm{other}} \quad \text{(other directions)} \\
    a'_{ghost,d} &= 0 \\
    b'_c &= \mathcal{D}_\mathrm{rescale} \, b_c - \sum_d  \mathcal{N}_{bc,d} \, \mathcal{R}_d \, u_{bc,d} \, a_{ghost,d}
\end{align}
...
For a cell $c$, we first scale the center coefficient and source term:
\begin{equation}
   a_c \leftarrow a_c \cdot \mathcal{D}_{rescale}, \quad b_c \leftarrow b_c \cdot \mathcal{D}_{rescale}
\end{equation}
...
\begin{align}
    b_c &\leftarrow b_c - (a_{nb,-} \cdot B_{val,-} + a_{nb,+} \cdot B_{val,+}) \\
